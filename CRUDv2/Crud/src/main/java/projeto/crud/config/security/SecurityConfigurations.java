...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
    ...
    protected  void configure(HttpSecurity http)throws Exception{
        http.authorizeRequests()//http autoriza as seguintes requisições
                ...
                .and().addFilterBefore(new AutenticacaoViaTokenFilter(tokenService, usuarioRepository), UsernamePasswordAuthenticationFilter.class); //Estamos dizendo aqui que é para chamar chamar o filtro de token antes de fazer a requisição.
